...
def split_data_by_group(data, group_col, train_ratio=0.7, val_ratio=0.2, test_ratio=0.1):
    """
    Splits the data into training, validation, and testing sets based on a grouping column.
    Groups with fewer than 3 samples are assigned entirely to the training set.
    ...
    - test_ratio (float): Proportion of data to include in the testing set.
